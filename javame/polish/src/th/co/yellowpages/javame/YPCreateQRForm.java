...
//#endif
	...
	private ChoiceGroup encodeChoiceGroup;
	private static final String WEB_CHOICE = "www";
  private static final String PHONE_CHOICE = "phone";
	private static final String SMS_CHOICE = "sms";
	private static final String MAIL_CHOICE = "email";
	private static final String TEXT_CHOICE = "text";
...
//#endif
	...
	private Image encode(String content) {
		int selectedIndex = encodeChoiceGroup.getSelectedIndex();
	...
	private void initForm() {
		textField = new TextField("Input: ", null, 256, TextField.ANY);
		textField.setPreferredSize(getWidth(), 65);
		append(textField);

		encodeChoiceGroup = new ChoiceGroup(null, Choice.EXCLUSIVE);
		defaultIndex = encodeChoiceGroup.append(WEB_CHOICE, null);
		encodeChoiceGroup.append(PHONE_CHOICE, null);
		encodeChoiceGroup.append(MAIL_CHOICE, null);
		encodeChoiceGroup.append(TEXT_CHOICE, null);
		encodeChoiceGroup.setSelectedIndex(defaultIndex, true);

		append(encodeChoiceGroup);
	}
