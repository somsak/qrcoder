...
//#endif
	...
	protected void pauseApp() {
		System.out.println("QRCoder: pauseApp");
//#ifdef polish.api.mmapi
		if (player != null) {
			try {
				player.stop();
...
//#= int width  = ${ polish.ScreenWidth };
			int vwidth  = videoControl.getDisplayWidth();
            int vheight = videoControl.getDisplayHeight(); 
			videoControl.setDisplayLocation((width - vwidth) / 2 , (height - vheight) / 2);
//#else
