...
public final class Contents {
	...
	public static final class Type {
		/**
		 * Plain text. Use Intent.putExtra(DATA, string). This can be used for URLs
		 * too, but string must include "http://" or "https://".
		 */
		...
		/**
		 * An SMS type. Use Intent.putExtra(DATA, string) where string is the number
		 * to SMS.
		 */
